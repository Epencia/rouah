...
export default function RetrouveAcces({ navigation }) {
  ...
  React.useEffect(() => {
    navigation.setOptions({ title: 'Retrouvez vos accès' });
    Animated.parallel([
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}retrouve-acces.php`, {
        method: 'POST',
        headers: {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={styles.title}>Vous avez perdu vos accès ?</Text>
            <Text style={styles.subtitle}>
              Saisissez votre adresse email pour recevoir vos accès
            </Text>
          </Animated.View>
            ...
            {!success ? (
              ...
              <View style={styles.successContainer}>
                ...
                <Text style={styles.successMessage}>
                  Un email contenant vos accès a été envoyé à {'\n'}
