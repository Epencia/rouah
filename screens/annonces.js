    ...
    return (
      <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white'}}>
        ...
        <TouchableOpacity
          ...
          style={{backgroundColor: '#fa4447', paddingVertical: 10, paddingHorizontal: 20, borderRadius: 5}}>
        ...
        renderItem={({item}) => (
          <View style={styles.annonceCard}>
            ...
            <View style={styles.actionButtons}>
              ...
              <TouchableOpacity 
                style={[styles.actionButton]}
                onPress={() => handleSMS(item.telephone)}
              >
              ...
              <TouchableOpacity 
                style={[styles.actionButton]}
                onPress={() => handleWhatsApp(item.telephone)}
              >
